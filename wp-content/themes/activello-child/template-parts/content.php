	...
	<div class="blog-item-wrap">
		<div class="post-inner-content">
			...
			<div class="entry-summary">
				<?php the_excerpt(); ?>
				<p><a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Lire plus', 'activello' ); ?></a></p>
			</div><!-- .entry-summary -->
			<?php else : ?>
			...
			?>
				...
				<div class="read-more">
					<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Lire plus', 'activello' ); ?></a>
				</div>
				<?php endif; ?>

				<?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) : ?>
					<div class="entry-footer">
						<span class="comments-link"><?php comments_popup_link( esc_html__( 'Aucun commentaire actuellement', 'activello' ), esc_html__( '1 Commentaire', 'activello' ), esc_html__( '% Commentaires', 'activello' ) ); ?></span>
					</div><!-- .entry-footer -->
				<?php endif; ?>
			</div><!-- .entry-content -->
			<?php endif; ?>
